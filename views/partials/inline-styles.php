 <style>:root{
    --sf-img-2: url("complete/resources/image_2.webp");
    --sf-img-4: url("complete/resources/image_3.webp");
    --sf-img-5: url("complete/resources/image_4.webp");
    --sf-img-9: url("complete/resources/image_5.webp");
    --sf-img-6: url("complete/resources/image_6.webp");
    --sf-img-3: url("complete/resources/image_7.webp");
    --sf-img-8: url("complete/resources/image_8.webp");
    --sf-img-7: url("complete/resources/image_9.webp")
}
 .sf-hidden{
 ...
 @font-face{
    ...
    font-style:normal;
    font-weight:100 900;
    src:url(complete/resources/font_10.woff2)format("woff2");
...
.bg-gray-950\/\[\.01\]{
    background-color:rgba(3,7,18,.01)
}
.bg-green-500{
    --tw-bg-opacity:1;
...
.bg-\[linear-gradient\(-75deg\2c hsl\(var\(--primary\)\/10\%\)_calc\(var\(--x\)\+20\%\)\2c hsl\(var\(--primary\)\/50\%\)_calc\(var\(--x\)\+25\%\)\2c hsl\(var\(--primary\)\/10\%\)_calc\(var\(--x\)\+100\%\)\)\]{
...
.hover\:-translate-x-0:hover,.hover\:-translate-y-1:hover{
    transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
}
...
.active\:scale-95:active,.active\:translate-y-\[1px\]:active{
    transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
}
...
.group[data-selected=true] .group-data-\[selected\=true\]\:bg-emerald-500{
    --tw-bg-opacity:1;
    background-color:rgb(16 185 129/var(--tw-bg-opacity))
}
...
.dark\:bg-\[radial-gradient\(circle_at_50\%_0\%\2c hsl\(var\(--primary\)\/10\%\)_0\%\2c transparent_60\%\)\]:is(.dark *){
...
.dark\:text-\[rgb\(255\2c 255\2c 255\2c 90\%\)\]:is(.dark *){
    color:hsla(0,0%,100%,.9)
}
...
.dark\:hover\:bg-gray-50\/\[\.15\]:hover:is(.dark *){
    background-color:rgba(249,250,251,.15)
}
