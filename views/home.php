...
<div class="w-full max-w-[70rem] mx-auto transition-all duration-200 p-4 bg-transparent border border-transparent rounded-xl justify-between items-center" style="position: fixed; top: 0; left: 50%; transform: translateX(-50%); z-index: 10;">
   ...
   <div class="flex items-center justify-between h-14 sm:h-16 gap-2 px-2">
        <div class="flex light-sweep items-center bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-full px-3 py-1.5 border border-purple-100 dark:border-purple-900/50 shadow-lg shadow-purple-100/20 dark:shadow-purple-900/20 min-w-[90px] sm:min-w-[120px]"><a class="relative group w-full" href=?page=home>
            <div class="relative flex flex-col items-center" style=opacity:1;transform:none><span class="text-base sm:text-xl font-black tracking-wider bg-gradient-to-r from-white to-gray-500 bg-clip-text text-transparent relative">MEGAEMBED</span>
                <div
    ...
    <nav class="flex-1 flex justify-center max-w-[45%] sm:max-w-none px-2">
        <div class="flex items-center bg-white/98 dark:bg-gray-800/50 backdrop-blur-sm rounded-full p-1.5 w-full sm:w-auto border border-purple-100 dark:border-purple-900/50 shadow-lg shadow-purple-100/20 dark:shadow-purple-900/20" style="width: 100%; max-width: 328px;"><a class="flex-1 px-2.5 sm:px-4 py-1.5 rounded-full transition-all duration-200 relative flex items-center justify-center gap-1.5 sm:gap-2 text-white" href=https://www.videasy.net/>
            ...
            <span
            class="relative z-10 tracking-wide hidden lg:block text-sm font-medium">Welcome</span>
                </a>
                <a class="flex-1 px-2.5 sm:px-4 py-1.5 rounded-full transition-all duration-200 relative flex items-center justify-center gap-1.5 sm:gap-2 text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400" href=?page=player><span class="relative z-10"><svg stroke=currentColor fill=none stroke-width=2 viewBox="0 0 24 24" aria-hidden=true class="w-5 h-5" height=1em width=1em xmlns=http://www.w3.org/2000/svg><path stroke-linecap=round stroke-linejoin=round d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap=round stroke-linejoin=round d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></span>
                    <span
                    class="relative z-10 tracking-wide hidden lg:block text-sm font-medium">Player</span>
                </a>
                <a class="flex-1 px-2.5 sm:px-4 py-1.5 rounded-full transition-all duration-200 relative flex items-center justify-center gap-1.5 sm:gap-2 text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400" href=?page=docs><span class="relative z-10"><svg stroke=currentColor fill=none stroke-width=2 viewBox="0 0 24 24" aria-hidden=true class="w-5 h-5" height=1em width=1em xmlns=http://www.w3.org/2000/svg><path stroke-linecap=round stroke-linejoin=round d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg></span>
                    <span
                    class="relative z-10 tracking-wide hidden lg:block text-sm font-medium">Docs</span>
                </a>
        </div>
    </nav>
    ...
    <div data-overlay-container=true>
      <div class="flex flex-col items-center justify-center w-full">
              ...
              <div class="flex gap-4 mt-2 cursor-pointer">
                <div class="p-4 gap-2  transition-all hover:-translate-y-1 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/[0.07] flex flex-col items-center">
                  <span class="text-2xl font-bold text-gray-300">
                    <span class="inline-block tabular-nums text-black dark:text-gray-300 tracking-wider">100</span>K+ </span>
                  <span class="text-xs text-gray-400 ">Movies</span>
                </div>
                <div class="p-4 gap-2 transition-all hover:-translate-y-1 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/[0.07] flex flex-col items-center">
                  <span class="text-2xl font-bold text-gray-300">
                    <span class="inline-block tabular-nums text-black dark:text-gray-300 tracking-wider">70</span>K+ </span>
                  <span class="text-xs text-gray-400">Shows</span>
                </div>
                <div class="p-4 gap-2 transition-all hover:-translate-y-1 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 hover:bg-white/[0.07] flex flex-col items-center">
                  <span class="text-2xl font-bold text-gray-300">
                    <span class="inline-block tabular-nums text-black dark:text-gray-300 tracking-wider">5</span>K+ </span>
            ...
            <div class="relative flex h-[500px] md:h-screen w-full flex-row items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl z-10">
                  ...
                  <figure class="relative h-52 w-36 cursor-pointer overflow-hidden rounded-xl border p-4 border-gray-950/[.1] bg-gray-950/[.01] hover:bg-gray-950/[.05] dark:border-gray-50/[.1] dark:bg-gray-50/[.10] dark:hover:bg-gray-50/[.15]">
                    <div class="flex flex-row items-center gap-2">
                      <img loading=lazy decoding=async data-nimg=fill class="object-cover w-full h-full" style="position:absolute;height:100%;width:100%;inset:0px;color:transparent;background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-2)!important;background-size:cover!important;background-origin:content-box!important;background-repeat:no-repeat!important" src='data:image/svg+xml,
																				<svg
																					xmlns="http://www.w3.org/2000/svg" width="220" height="330">
																					<rect fill-opacity="0"/>
																				</svg>'>
                    </div>
                  </figure>
              ...
              <div class="group flex overflow-hidden p-2 [--gap:1rem] [gap:var(--gap)] flex-col [--duration:20s]">
                <div class="flex shrink-0 justify-around [gap:var(--gap)] animate-marquee-vertical flex-col group-hover:[animation-play-state:paused] [animation-direction:reverse]">
                  <figure class="relative h-52 w-36 cursor-pointer overflow-hidden rounded-xl border p-4 border-gray-950/[.1] bg-gray-950/[.01] hover:bg-gray-950/[.05] dark:border-gray-50/[.1] dark:bg-gray-50/[.10] dark:hover:bg-gray-50/[.15]">
                    <div class="flex flex-row items-center gap-2">
                      <img loading=lazy decoding=async data-nimg=fill class="object-cover w-full h-full" style="position:absolute;height:100%;width:100%;inset:0px;color:transparent;background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-6)!important;background-size:cover!important;background-origin:content-box!important;background-repeat:no-repeat!important" src='data:image/svg+xml,
																																				<svg
																																					xmlns="http://www.w3.org/2000/svg" width="220" height="330">
																																					<rect fill-opacity="0"/>
																																				</svg>'>
                  ...
                  <figure class="relative h-52 w-36 cursor-pointer overflow-hidden rounded-xl border p-4 border-gray-950/[.1] bg-gray-950/[.01] hover:bg-gray-950/[.05] dark:border-gray-50/[.1] dark:bg-gray-50/[.10] dark:hover:bg-gray-50/[.15]">
                    <div class="flex flex-row items-center gap-2">
                      <img loading=lazy decoding=async data-nimg=fill class="object-cover w-full h-full" style="position:absolute;height:100%;width:100%;inset:0px;color:transparent;background-blend-mode:normal!important;background-clip:content-box!important;background-position:50% 50%!important;background-color:rgba(0,0,0,0)!important;background-image:var(--sf-img-9)!important;background-size:cover!important;background-origin:content-box!important;background-repeat:no-repeat!important" src='data:image/svg+xml,
																																							<svg
																																								xmlns="http://www.w3.org/2000/svg" width="220" height="330">
																																								<rect fill-opacity="0"/>
																																							</svg>'>
        ...
        <div class="flex flex-col gap-4 my-10" style="width: 95%; max-width: 1100px; margin: 0 auto;">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-2.5">
            <div class="p-4 space-y-3 transition-all hover:-translate-y-1 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 hover:bg-white/[0.07]">
              ...
              <p class="text-lg font-medium">Easy to use
              <p class="text-sm text-gray-400">Intuitive and easy to use. Just copy the link and embed it into your website</p>
            </div>
            <div class="p-4 space-y-3 transition-all hover:-translate-y-1 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 hover:bg-white/[0.07]">
              ...
              <p class="text-lg font-medium">Huge Library
              <p class="text-sm text-gray-400">With movies and shows scraped from multiple websites, we have it all!</p>
            </div>
            <div class="p-4 space-y-3 transition-all hover:-translate-y-1 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 hover:bg-white/[0.07]">
              ...
              <p class="text-lg font-medium">Customizable
              <p class="text-sm text-gray-400">You can customize the player to your needs, using only query parameters</p>
            </div>
            <div class="p-4 space-y-3 transition-all hover:-translate-y-1 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 hover:bg-white/[0.07]">
              ...
              <p class="text-lg font-medium">Auto Update
              <p class="text-sm text-gray-400">Content added every day, updated automatically</p>
            </div>
            <div class="p-4 space-y-3 transition-all hover:-translate-y-1 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 hover:bg-white/[0.07]">
              ...
              <p class="text-lg font-medium">Highest Quality
              <p class="text-sm text-gray-400">Latest available quality and the fastest</p>
            </div>
          </div>
        </div>
        <div class="fixed flex items-center gap-2 bottom-4">
          <button class="relative light-sweep px-6 py-2 font-medium backdrop-blur-xl transition-[box-shadow] duration-300 ease-in-out hover:shadow dark:bg-[radial-gradient(circle_at_50%_0%,hsl(var(--primary)/10%)_0%,transparent_60%)] dark:hover:shadow-[0_0_20px_hsl(var(--primary)/10%)] rounded-full bg-blue-600/50" tabindex=0 style=--x:-100%;will-change:auto;transform:none>
            <span class="relative  items-center h-full w-full text-sm uppercase flex gap-2 tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]" style="mask-image:linear-gradient(-75deg,hsl(var(--primary)) calc(var(--x) + 20%),transparent calc(var(--x) + 30%),hsl(var(--primary)) calc(var(--x) + 100%))">
              <a href=https://t.me/+vidlinkpro target=_blank rel=noreferrer>
                <img src="resources/image_12.webp" width=25 height=25 alt="telegram icon">
              </a>
            </span>
            <span style="mask:linear-gradient(rgb(0,0,0),rgb(0,0,0)) content-box,linear-gradient(rgb(0,0,0),rgb(0,0,0));mask-composite:exclude" class="absolute inset-0 z-10 block rounded-[inherit] bg-[linear-gradient(-75deg,hsl(var(--primary)/10%)_calc(var(--x)+20%),hsl(var(--primary)/50%)_calc(var(--x)+25%),hsl(var(--primary)/10%)_calc(var(--x)+100%))] p-px"></span>
          </button>
          <button class="relative light-sweep px-6 py-2 font-medium backdrop-blur-xl transition-[box-shadow] duration-300 ease-in-out hover:shadow dark:bg-[radial-gradient(circle_at_50%_0%,hsl(var(--primary)/10%)_0%,transparent_60%)] dark:hover:shadow-[0_0_20px_hsl(var(--primary)/10%)] rounded-full bg-indigo-600/20" tabindex=0 style=--x:-100%;will-change:auto;transform:none>
            <span class="relative items-center h-full w-full text-sm uppercase flex gap-2 tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]" style="mask-image:linear-gradient(-75deg,hsl(var(--primary)) calc(var(--x) + 20%),transparent calc(var(--x) + 30%),hsl(var(--primary)) calc(var(--x) + 100%))">Entre No Telegram <a href=https://t.me/+vidlinkpro target=_blank rel=noreferrer>
                <img src="resources/image_11.png" width=25 height=25 alt="telegram icon">
              </a>
            </span>
            <span style="mask:linear-gradient(rgb(0,0,0),rgb(0,0,0)) content-box,linear-gradient(rgb(0,0,0),rgb(0,0,0));mask-composite:exclude" class="absolute inset-0 z-10 block rounded-[inherit] bg-[linear-gradient(-75deg,hsl(var(--primary)/10%)_calc(var(--x)+20%),hsl(var(--primary)/50%)_calc(var(--x)+25%),hsl(var(--primary)/10%)_calc(var(--x)+100%))] p-px"></span>
          </button>
        ...
        <div class="w-full p-4 pb-20 text-center">
          ...
          <span class="text-sm text-white/80">© 2024 VidLink. All rights reserved</span>
        </div>
      </div>
    </div>
